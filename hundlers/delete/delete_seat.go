...
type DeleteSeatResponseSuccess struct {
	Message string       `json:"message"`
	Deleted db.SeatModel `json:"deleted"`
}
...
func DeleteSeat(w http.ResponseWriter, r *http.Request) {
	...
	defer func() {
		...
		if status == http.StatusOK {
			res := new(DeleteSeatResponseSuccess)
	...
	// Delete
	d, err := client.Seat.FindUnique(
		db.Seat.ID.Equals(id),
